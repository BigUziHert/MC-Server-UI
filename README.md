...
To use software you installed yourself, choose **Import an existing server** and select its folder. New server creation always installs the selected software or modpack; there is no empty-server or demo option.
